...
if __name__ == '__main__':
    ...
    converterGpu = GrayscaleConverterGPU(IMAGE_SIZE)
    converterCpu = GrayscaleConverterCPU(IMAGE_SIZE)
    ...
    gray_gpu_image.save('image_gpu.jpg')
    gray_cpu_image = Image.fromarray(gray_cpu, 'L')
    gray_cpu_image.save('image_cpu.jpg')
